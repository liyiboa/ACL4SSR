...
#######################
# GitHub 相关配置
GH_DOWNLOAD_URL="${GH_PROXY}https://github.com/Yxiguan/Alist_123/releases/latest/download"
#######################
...
INSTALL() {
  ...
  if [ -n "$proxy_input" ]; then
    ...
    # 如果不需要代理，直接使用默认链接
    GH_DOWNLOAD_URL="https://github.com/Yxiguan/Alist_123/releases/latest/download"
